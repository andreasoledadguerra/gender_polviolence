"""TODO 
a) modificar la funcion colored (ùnico), que muestre las barras por region pero que coloree laque solicita el usuario
b) modificar la función highlighted, que muestre el filtro por evento (por cada región)
Challenge: armar un main.py nuevo llamado 'main2.py' , que debe ser muy simple. COndicion 1: 
